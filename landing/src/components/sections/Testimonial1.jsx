      ...
      <div className="section section-testimonial1" id="testimonial1">
        <div className="container">
          <div className="section__header">
            ...
            <p>
              Những website do NetS web làm ra mang lại hiệu quả và khách hàng được phục vụ tận tình, cảm thấy hài lòng đó là mục tiêu mà tất cả đội ngũ của NetS web hướng đến. Những lời nhận xét của khách hàng là động lực để chúng tôi nâng cao chất lượng dịch vụ hơn và làm hài lòng khách hàng hơn nữa!
            </p>
          </div>
